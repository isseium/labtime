    ...
    describe "POST create" do
      ...
      describe "with invalid params" do
        it "assigns a newly created but unsaved like as @like" do
          ...
          post :create, {:like => { "work" => "invalid value" }}, valid_session
          assigns(:like).should be_a_new(Like)
        end
    ...
    describe "PUT update" do
      describe "with valid params" do
        it "updates the requested like" do
          ...
          Like.any_instance.should_receive(:update_attributes).with({ "work" => "" })
          put :update, {:id => like.to_param, :like => { "work" => "" }}, valid_session
        end
      ...
      describe "with invalid params" do
        it "assigns the like as @like" do
          ...
          # Trigger the behavior that occurs when invalid params are submitted
          Like.any_instance.stub(:save).and_return(false)
          put :update, {:id => like.to_param, :like => { "work" => "invalid value" }}, valid_session
          assigns(:like).should eq(like)
        end
